            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="product in productStore.getProducts" :key="product.ProduktID">
                        ...
                        <td>
                            <button @click="decrementStock(product)">-</button>
                            <button @click="incrementStock(product)">+</button>
                            <input type="number" v-model="product.Lagerbestand" />
                            <button @click="updateStock(product)">Update</button>
                            <button @click="resetStock(product)">Reset</button>
                        </td>
                    </tr>
                </tbody>
            </table>
